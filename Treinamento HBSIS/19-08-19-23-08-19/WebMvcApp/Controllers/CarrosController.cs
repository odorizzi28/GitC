...
namespace WebMvcApp.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            Carro carros = db.carros.Find(id);
            if (carros == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "Id,Placa")] Carro carros)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Placa")] Carro carros)
        {
            if (ModelState.IsValid)
            {
